...
export default function DebriefingsPage() {
  ...
  const [newDebriefing, setNewDebriefing] = useState({
    ...
    lieu: "",
    typeIntervention: "Intervention médicale",
    agentsPresents: "",
    resume: "",
    deroulement: "",
    resultat: "",
  ...
  return (
    <div className="page-enter">
      <PageHeader
        brand="ClearRescue"
        title="Debriefings"
        subtitle="Comptes-rendus et rapports d'intervention médicale"
      />
        ...
        {showCreateForm && (
          <div className="mt-4 panel-soft p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block mb-2 text-sm font-medium text-muted">Ambulanciers présents (séparés par des virgules)</label>
                <input
                  type="text"
                  className="input-field w-full"
          ...
          {debriefings.map((debriefing) => (
            <div key={debriefing.id} className="panel-soft p-6">
              ...
              <div className="mb-4">
                ...
                <p className="text-xs text-muted mb-2">Ambulanciers: {debriefing.agentsPresents.join(', ')}</p>
              </div>
